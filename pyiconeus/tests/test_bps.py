...
from pyiconeus.io.base import read_bps, read_scan
...
def test_load_bps_v2():
    bps = read_bps(testDataPath + "/4Dscan_11_StimVIS16__60_30_60_8_fus3D.source_v2.bps")
    assert bps is not None
...
def test_bps_v2_data():
    data_true = np.array([[0.000004845665888, 0.003799318538138, -0.0001917964938, -0.008609746195099],
     ...
     [0.0, 0.0, 0.0, 1.0]])
    bps: Bps = read_bps(testDataPath + "/4Dscan_11_StimVIS16__60_30_60_8_fus3D.source_v2.bps")  # ty:ignore[invalid-assignment]
    print("data: ")
    print(data_true)
    print("bps data: ")
    print(bps.data)
